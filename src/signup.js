...
function Signup() {
    ...
    const [data, setData] = useState(JSON.parse(localStorage.getItem("hendal")) || []);
    ...
    const fontSubmit = () => {
        ...
        localStorage.setItem("hendal", JSON.stringify([...data, student]));
        navigate("/tableSignup")
    }
        ...
        <>
            <div className="container mt-5">
                ...
                <div className="row d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div className="  col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                        <button type="sibmit" className="btn btn-info form-control mt-5" onClick={fontSubmit}>Sign Up</button>
                    </div>
                </div>
